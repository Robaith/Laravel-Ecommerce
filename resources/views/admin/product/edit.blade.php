...
<div class="sl-mainpanel">
 ...
 <a href="{{ route('products')}}" class="btn btn-success btn-sm pull-right" style="background: blue"> All Product</a>
          </h6>
...
<br><br>
 ...
 <div class="card pd-20 pd-sm-40">
  ...
  <form method="post" action="{{ route('update.product.photo', $product->id) }} " enctype="multipart/form-data">    
        @csrf
