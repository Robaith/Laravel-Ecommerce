...
<div class="sl-mainpanel">
	...
	<div class="sl-pagebody">
		<div class="sl-page-title">
			...
			<p align="right">
				<a href="" class="btn btn-sm btn-info" data-toggle="modal" data-target="#modaldemo3">Add Sub-Category</a>
			</p>
		</div><!-- sl-page-title -->
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<a href="{{ route('destroy.subcategory', $row->id) }}" class="btn btn-sm btn-danger" id="delete">Delete</a>
							</td>
						</tr>
						@endforeach
						</tbody>
